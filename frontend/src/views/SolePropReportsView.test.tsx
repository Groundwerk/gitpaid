...
const overview: any = {
  ...
  totals: { cad: 20700, tax: 984.13, cpp: 2046.8, cpp2: 0 },
  deposits: [
    { id: 1, received_date: '2026-09-01', foreign_amount: 5000, currency: 'USD', fx_rate: 1.38, fx_date_used: '2026-09-01', cad_amount: 6900, tax_owed: 0, cpp_owed: 404.6, cpp2_owed: 0, note: null, voided: 0 },
    { id: 2, received_date: '2026-10-01', foreign_amount: 10000, currency: 'USD', fx_rate: 1.38, fx_date_used: '2026-10-01', cad_amount: 13800, tax_owed: 984.13, cpp_owed: 1642.2, cpp2_owed: 0, note: 'Deel, Oct', voided: 0 },
    { id: 3, received_date: '2027-01-15', foreign_amount: 2000, currency: 'USD', fx_rate: 1.4, fx_date_used: '2027-01-15', cad_amount: 2800, tax_owed: 100, cpp_owed: 0, cpp2_owed: 0, note: null, voided: 0 },
  ],
  upcoming: [],
...
describe('buildEarningsCsv', () => {
  it('emits a header plus one row per deposit', () => {
    ...
    expect(lines[0]).toBe('received_date,currency,foreign_amount,fx_rate,fx_date_used,cad_amount,tax_owed,cpp_owed,cpp2_owed,note');
    expect(lines).toHaveLength(4);
    expect(lines[1]).toBe('2026-09-01,USD,5000,1.38,2026-09-01,6900,0,404.6,0,');
